...
FIG  = ROOT / "figures"
OUT  = REPORT_DIR / "SYNTHESE_TUTEUR.pdf"

# Portable Unicode font (DejaVu Sans ships with matplotlib, covers Latin + Greek
# math symbols). Avoids the previous hardcoded macOS "/Library/Fonts/..." path.
_FONT_TTF = Path(matplotlib.get_data_path()) / "fonts" / "ttf"
FONT_REGULAR = str(_FONT_TTF / "DejaVuSans.ttf")
FONT_BOLD    = str(_FONT_TTF / "DejaVuSans-Bold.ttf")
FONT_ITALIC  = str(_FONT_TTF / "DejaVuSans-Oblique.ttf")
...
pdf.add_font("ArialU", "I", FONT_ITALIC)
pdf.add_page()
